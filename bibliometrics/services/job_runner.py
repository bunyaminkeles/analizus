...
def run_bibliometric_job(job_id: str, file_content: str) -> None:
    """
    Analiz işini arka planda başlat.
    file_content: yüklenen dosyanın metin içeriği (str)
    """
    def _run():
        ...
        try:
            ...
            # 1. Parse
            records, fmt = parse_file(file_content)
            if not records:
    ...
    def _run():
        ...
        try:
            ...
            body_lines = [
                ...
                f'─────────────────────────────────────',
                f'TAM RAPOR (10 Analiz) - 150 TL',
                f'─────────────────────────────────────',
                f'  • Yıllara Göre Yayın Trendi',
                f'  • En Verimli Yazarlar',
                f'  • Anahtar Kelime Bulutu',
                f'  • En Çok Atıf Alan Yayınlar',
                f'  • En Çok Yayın Yapılan Dergiler',
                f'  • Kurum / Ülke Dağılımı',
                f'  • Yazar İşbirliği Ağı',
                f'  • Yayın Türleri Dağılımı',
                f'  • Atıf Analizi + H-index',
    ...
    def _run():
        ...
        try:
            ...
            body_lines = [
                ...
                '',
                '===========================================',
                f'TAM RAPOR (10 Analiz) - {price} TL',
                '===========================================',
                '  - Yayın Trendi + En Verimli Yazarlar',
                '  - Anahtar Kelime Bulutu',
                '  - En Cok Atif Alan Yayinlar',
                '  - En Cok Yayın Yapılan Dergiler',
                '  - Kurum/Ulke Dagilimi',
                '  - Yazar Isbirligi Agi',
                '  - Yayin Turleri Dagilimi',
                '  - Atif Analizi + H-index',
                '  - Yillik Atif Trendi',
                '',
