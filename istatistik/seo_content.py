...
SEO_CONTENT = {
    ...
    'ttesti': {
        'intro': (
            gettext_lazy('T-testi, iki grup ya da ölçüm seti arasındaki ortalama farkın istatistiksel olarak '
        ...
        'when_to_use': (
            gettext_lazy('Bağımsız örneklem t-testini; iki farklı ve birbirinden bağımsız grubu '
        ...
        'assumptions': (
            gettext_lazy('Normallik: Her grup yaklaşık normal dağılıma sahip olmalıdır (Shapiro-Wilk p > 0.05 '
        ...
        'how_to_interpret': (
            gettext_lazy('p < 0.05: Gruplar arasındaki fark istatistiksel olarak anlamlıdır. '
        ...
        'apa_example': (
            gettext_lazy('Deney grubu (M = 78.4, SS = 9.2) kontrol grubuna (M = 71.6, SS = 10.1) '
            'kıyasla anlamlı düzeyde yüksek puan almıştır, t(58) = 2.84, p = .006, '
            "d = 0.71, %95 GA [1.98, 11.62].")
        ),
        'faq': [
            {
                'q': gettext_lazy('T-testi mi, Mann-Whitney mi seçmeliyim?'),
                'a': (gettext_lazy('Veriler normal dağılım gösteriyorsa veya n ≥ 30 ise t-testi tercih edin. '
                      'Küçük örneklemde normallik varsayımı sağlanmıyorsa Mann-Whitney U daha '
                      'güvenilir sonuç verir.')),
            },
            {
                'q': gettext_lazy('Levene testi p < 0.05 çıktı, ne yapmalıyım?'),
                'a': (gettext_lazy('Varyanslar homojen değil demektir. Analizus otomatik olarak Welch t-testi '
                      'uygular; ayrıca bir işlem yapmanıza gerek yoktur.')),
            },
            {
                'q': gettext_lazy('Tek yönlü mü, çift yönlü mü kullanmalıyım?'),
                'a': (gettext_lazy('Literatürde güçlü teorik gerekçe olmadıkça çift yönlü (two-tailed) test '
                      'kullanın. Tek yönlü test yalnızca farkın yönünü önceden kesin bildiğinizde '
                      'tercih edilir.')),
            },
            {
                'q': gettext_lazy('Sonuçları tezimde nasıl raporlamalıyım?'),
                'a': (gettext_lazy("APA 7 formatında t değeri, serbestlik derecesi, p değeri, Cohen's d ve "
                      '%95 güven aralığını bildirin. Analizus PDF raporu bu bilgilerin tamamını '
                      'hazır sunar.')),
            },
        ],
        'related_tools': [
            ('mann-whitney', gettext_lazy('Mann-Whitney U Testi')),
            ('anova', gettext_lazy('Tek Yönlü ANOVA')),
            ('wilcoxon', gettext_lazy('Wilcoxon Testi')),
            ('normallik', gettext_lazy('Normallik Testi')),
            ('orneklem', gettext_lazy('Örneklem Büyüklüğü')),
        ],
    },

    'anova': {
        'intro': (
            gettext_lazy('Tek yönlü ANOVA (Analysis of Variance), üç veya daha fazla bağımsız grubun '
        ...
        'when_to_use': (
            gettext_lazy('Üç veya daha fazla bağımsız grubu (örn. düşük/orta/yüksek gelir; A/B/C tedavisi) '
        ...
        'assumptions': (
            gettext_lazy('Normallik: Her grubun verileri normal dağılıma yakın olmalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('F istatistiği ve p değeri: p < 0.05 en az iki grup arasında anlamlı fark '
        ...
        'apa_example': (
            gettext_lazy('Gruplar arasında akademik başarı ortalamaları açısından anlamlı fark '
        ...
        'faq': [
            {
                'q': gettext_lazy('ANOVA anlamlı çıktı ama post-hoc çıkmadı, neden?'),
                'a': (gettext_lazy('ANOVA tüm gruplar arasında genel bir fark olduğunu gösterir. Post-hoc '
            ...
            {
                'q': gettext_lazy('Kaç grubu karşılaştırabilirim?'),
                'a': (gettext_lazy('Teorik bir üst sınır yoktur, ancak çok sayıda grup post-hoc '
                      'karşılaştırmaları zorlaştırır ve I. tip hata riskini artırır. '
                      '3-6 grup için ANOVA idealdir.')),
            },
            {
                'q': gettext_lazy('Tukey mu, Bonferroni mu seçmeliyim?'),
                'a': (gettext_lazy('Tukey HSD, eşit örneklem büyüklüklerinde tercih edilir ve daha güçlüdür. '
                      'Bonferroni, az sayıda karşılaştırma ve dengesiz gruplar için uygundur.')),
            },
        ],
        'related_tools': [
            ('ttesti', gettext_lazy('T-Testi')),
            ('kruskal-wallis', gettext_lazy('Kruskal-Wallis Testi')),
            ('tekrarli-anova', gettext_lazy('Tekrarlı Ölçümler ANOVA')),
            ('orneklem', gettext_lazy('Örneklem Büyüklüğü')),
        ],
    },
    ...
    'mann_whitney': {
        'intro': (
            gettext_lazy('Mann-Whitney U Testi, iki bağımsız grubun dağılımlarını karşılaştıran '
        ...
        'when_to_use': (
            gettext_lazy('İki bağımsız grubu karşılaştırmak istediğinizde ve veriler normal dağılım '
        ...
        'assumptions': (
            gettext_lazy('Bağımsızlık: İki grup birbirinden bağımsız olmalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('U istatistiği: Küçük U değeri iki grubun birbirinden ayrıştığını gösterir. '
        ...
        'apa_example': (
            gettext_lazy('Deney grubu (Md = 24.5) kontrol grubuna (Md = 18.0) kıyasla anlamlı '
            'düzeyde yüksek puan almıştır, U = 312, p = .018, r = .34.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Mann-Whitney ortalamayı mı, medyanı mı karşılaştırır?'),
                'a': (gettext_lazy('Teknik olarak sıra dağılımlarını karşılaştırır. Grupların dağılım '
                      'şekilleri benzerse medyanlar arasındaki farkı test etmiş olur.')),
            },
            {
                'q': gettext_lazy('Örneklem büyükse t-testi mi kullanmalıyım?'),
                'a': (gettext_lazy('n ≥ 30 olduğunda merkezi limit teoremi devreye girer ve t-testi '
    ...
    'kruskal_wallis': {
        'intro': (
            gettext_lazy('Kruskal-Wallis H Testi, üç veya daha fazla bağımsız grubu karşılaştıran '
        ...
        'when_to_use': (
            gettext_lazy('Üç veya daha fazla bağımsız grubu karşılaştırmak istediğinizde ve veriler '
        ...
        'assumptions': (
            gettext_lazy('Bağımsızlık: Tüm gruplar birbirinden bağımsız olmalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('H istatistiği: Büyük H değeri gruplar arası farkın arttığını gösterir. '
        ...
        'apa_example': (
            gettext_lazy('Üç grup arasında test puanları açısından anlamlı fark bulunmuştur, '
            'H(2) = 12.47, p = .002. Dunn post-hoc analizi A ve C grupları '
            'arasındaki farkın anlamlı olduğunu göstermiştir (p = .003).')
        ),
        'faq': [
            {
                'q': gettext_lazy('ANOVA yerine ne zaman Kruskal-Wallis kullanmalıyım?'),
                'a': (gettext_lazy('Normallik varsayımı karşılanmıyorsa, örneklem küçükse veya '
                      'veriler ordinal ölçekliyse Kruskal-Wallis tercih edin.')),
            },
            {
                'q': gettext_lazy('Kruskal-Wallis anlamlı çıktı, sonra ne yapmalıyım?'),
                'a': (gettext_lazy('Hangi grup çiftlerinin farklılaştığını bulmak için Dunn post-hoc '
        ...
        'related_tools': [
            ('anova', gettext_lazy('Tek Yönlü ANOVA')),
            ('mann-whitney', gettext_lazy('Mann-Whitney U Testi')),
            ('friedman', gettext_lazy('Friedman Testi')),
            ('normallik', gettext_lazy('Normallik Testi')),
        ],
    },
    ...
    'ki_kare': {
        'intro': (
            gettext_lazy('Ki-Kare Testi, kategorik değişkenler arasındaki ilişkiyi veya gözlenen '
        ...
        'when_to_use': (
            gettext_lazy('İki kategorik değişken arasında ilişki olup olmadığını araştırmak '
        ...
        'assumptions': (
            gettext_lazy('Bağımsızlık: Her gözlem yalnızca bir kategoride yer almalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('χ² istatistiği: Büyük değer gözlenen ve beklenen frekanslar arasındaki '
        ...
        'apa_example': (
            gettext_lazy('Cinsiyet ile program tercihi arasında anlamlı bir ilişki bulunmuştur, '
            "χ²(2, N = 150) = 11.34, p = .003, Cramer's V = .27.")
        ),
        'faq': [
            {
                'q': gettext_lazy('Ki-Kare mi, Fisher\'s Exact mı kullanmalıyım?'),
                'a': (gettext_lazy('Herhangi bir hücrenin beklenen frekansı 5\'in altındaysa '
                      'Fisher\'s Exact Test tercih edilmelidir. Analizus bunu otomatik kontrol eder.')),
            },
            {
                'q': gettext_lazy('Ki-Kare ilişkinin gücünü gösterir mi?'),
                'a': (gettext_lazy("Hayır; χ² yalnızca anlamlılığı gösterir. İlişkinin gücü için Cramer's V "
                      "veya Phi katsayısına bakın.")),
            },
        ],
        'related_tools': [
            ('korelasyon', gettext_lazy('Korelasyon Analizi')),
            ('lojistik-regresyon', gettext_lazy('Lojistik Regresyon')),
        ],
    },

    'korelasyon': {
        'intro': (
            gettext_lazy('Korelasyon analizi, iki sürekli değişken arasındaki doğrusal ilişkinin '
        ...
        'when_to_use': (
            gettext_lazy('İki sürekli değişken arasında ilişki olup olmadığını ve varsa yönünü '
        ...
        'assumptions': (
            gettext_lazy('Pearson için: Her iki değişken de sürekli ve yaklaşık normal dağılımlı '
        ...
        'how_to_interpret': (
            gettext_lazy('r değeri: +1 mükemmel pozitif, −1 mükemmel negatif, 0 ilişki yok. '
        ...
        'apa_example': (
            gettext_lazy('Çalışma süresi ile sınav puanı arasında orta düzeyde pozitif bir ilişki '
            'bulunmuştur, r(98) = .54, p < .001.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Korelasyon nedensellik kanıtlar mı?'),
                'a': (gettext_lazy('Hayır. İki değişken arasındaki ilişki bir üçüncü değişkenden '
                      'kaynaklanıyor olabilir. Nedensellik için deney tasarımı veya '
                      'yapısal eşitlik modellemesi gerekir.')),
            },
            {
                'q': gettext_lazy('Kaç değişken arasında korelasyon hesaplayabilirim?'),
                'a': (gettext_lazy('Analizus birden fazla değişken içeren veri setlerinde tüm çiftler '
                      'için otomatik korelasyon matrisi oluşturur.')),
            },
        ],
        'related_tools': [
            ('lineer-regresyon', gettext_lazy('Doğrusal Regresyon')),
            ('ttesti', gettext_lazy('T-Testi')),
            ('normallik', gettext_lazy('Normallik Testi')),
        ],
    },
    ...
    'cronbach': {
        'intro': (
            gettext_lazy('Cronbach Alfa katsayısı, bir ölçeğin veya anketin iç tutarlılığını '
        ...
        'when_to_use': (
            gettext_lazy('Birden fazla madde (soru) ile ölçülen bir yapının (tutum, yetenek, '
        ...
        'assumptions': (
            gettext_lazy('Essensiyal tau-eşdeğerliği: Maddeler aynı yapıyı ölçmeli, '
        ...
        'how_to_interpret': (
            gettext_lazy('α < 0.60: Kabul edilemez. 0.60–0.70: Düşük / sınırda. '
        ...
        'apa_example': (
            gettext_lazy('Ölçeğin iç tutarlılığı yüksek bulunmuştur (α = .87, 12 madde).')
        ),
        'faq': [
            {
                'q': gettext_lazy('Alfa çok yüksek çıktı (α > 0.95), sorun var mı?'),
                'a': (gettext_lazy('Çok yüksek alfa, maddelerin birbirinin tekrarı olduğuna '
                      '(madde artıklığı) işaret edebilir. Madde-toplam korelasyonlarını '
                      'inceleyin ve benzer içerikli maddeleri gözden geçirin.')),
            },
            {
                'q': gettext_lazy('Ters maddeler varsa ne yapmalıyım?'),
                'a': (gettext_lazy('Ters kodlu maddeleri analize girmeden önce dönüştürün '
                      '(örn. 1→5, 2→4 şeklinde). Aksi takdirde alfa hatalı hesaplanır.')),
            },
            {
                'q': gettext_lazy('Alt boyutlar için ayrı alfa hesaplamalı mıyım?'),
                'a': (gettext_lazy('Evet. Çok boyutlu ölçeklerde her alt boyut için ayrı güvenilirlik '
                      'analizi yapın; toplam ölçek için tek alfa yanıltıcı olabilir.')),
            },
        ],
        'related_tools': [
            ('afa', gettext_lazy('Açıklayıcı Faktör Analizi')),
            ('betimsel', gettext_lazy('Betimsel İstatistik')),
        ],
    },

    'normallik': {
        'intro': (
            gettext_lazy('Normallik testi, bir veri setinin normal (Gaussian) dağılıma ne ölçüde '
        ...
        'when_to_use': (
            gettext_lazy('Parametrik bir test uygulamadan önce varsayım kontrolü olarak kullanın. '
        ...
        'assumptions': (
            gettext_lazy('Bağımsızlık: Gözlemler birbirinden bağımsız olmalıdır. '
            'Süreklilik: Değişken sürekli ölçekte olmalıdır. '
            'Örneklem büyüklüğü: Shapiro-Wilk n = 3 ile n = 5000 arasında güvenilir '
            'sonuç verir.')
        ),
        'how_to_interpret': (
            gettext_lazy('Shapiro-Wilk p > 0.05: Normal dağılımdan anlamlı sapma yoktur. '
        ...
        'apa_example': (
            gettext_lazy('Shapiro-Wilk testi verilerin normal dağılımdan anlamlı biçimde '
            'sapmadığını göstermiştir, W = .97, p = .214.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Normallik testi anlamlı çıktı; ne yapmalıyım?'),
                'a': (gettext_lazy('Parametrik olmayan bir test kullanmayı düşünün. İki grup için '
                      'Mann-Whitney U, üç veya daha fazla grup için Kruskal-Wallis, '
                      'bağımlı gruplar için Wilcoxon uygun alternatiflerdir.')),
            },
            {
                'q': gettext_lazy('Büyük örneklemde Shapiro-Wilk her zaman anlamlı çıkıyor, neden?'),
                'a': (gettext_lazy('Örneklem büyüdükçe test gücü artar; küçük, pratik önemi olmayan '
    ...
    'betimsel': {
        'intro': (
            gettext_lazy('Betimsel istatistik analizi, veri setindeki değişkenleri özetlemenin '
        ...
        'when_to_use': (
            gettext_lazy('Herhangi bir ileri analize geçmeden önce veriyi tanımak için kullanın. '
        ...
        'assumptions': (
            gettext_lazy('Betimsel istatistik herhangi bir dağılım varsayımı gerektirmez; '
        ...
        'how_to_interpret': (
            gettext_lazy('Ortalama: Merkezi eğilimin en yaygın ölçütü; aykırı değerlere duyarlıdır. '
        ...
        'apa_example': (
            gettext_lazy('Katılımcıların yaş ortalaması 28.4 (SS = 5.7, Çarpıklık = 0.42) '
            'olarak hesaplanmıştır.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Ortalama mı, medyan mı raporlamalıyım?'),
                'a': (gettext_lazy('Normal dağılımlı sürekli değişkenler için ortalama ± SS; '
                      'çarpık dağılımlar ve ordinal veriler için medyan (IQR) tercih edin.')),
            },
            {
                'q': gettext_lazy('Frekans tablosu ile çapraz tablo arasındaki fark nedir?'),
                'a': (gettext_lazy('Frekans tablosu tek bir kategorik değişkeni özetler. '
        ...
        'related_tools': [
            ('normallik', gettext_lazy('Normallik Testi')),
            ('korelasyon', gettext_lazy('Korelasyon Analizi')),
            ('cronbach', gettext_lazy('Cronbach Alfa')),
        ],
    },

    'orneklem': {
        'intro': (
            gettext_lazy('Örneklem büyüklüğü hesaplayıcı, bir araştırmanın istenen istatistiksel '
        ...
        'when_to_use': (
            gettext_lazy('Veri toplamaya başlamadan önce araştırma tasarımı aşamasında kullanın. '
        ...
        'assumptions': (
            gettext_lazy('Etki büyüklüğü tahmini: Daha önce yapılmış araştırmalar veya pilot '
        ...
        'how_to_interpret': (
            gettext_lazy("Cohen's d etki büyüklüğü: 0.2 küçük, 0.5 orta, 0.8 büyük. "
        ...
        'apa_example': (
            gettext_lazy("Orta etki büyüklüğü (d = 0.5), α = .05 ve %80 güç için her grupta "
            'en az 64 katılımcı gerektiği hesaplanmıştır.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Etki büyüklüğünü bilmiyorum; ne girmeliyim?'),
                'a': (gettext_lazy('Alanyazında benzer çalışmaların raporladığı etki büyüklüğünü '
                      'kullanın. Bilgi yoksa orta etki (d = 0.5, f = 0.25) kabul '
                      'görmüş muhafazakâr bir başlangıç noktasıdır.')),
            },
            {
                'q': gettext_lazy('Hesaplanan örneklem büyüklüğüne ulaşamıyorum, ne yapmalıyım?'),
                'a': (gettext_lazy('Daha büyük bir etki büyüklüğü hedefleyebilir veya gücü '
    ...
    'lineer_regresyon': {
        'intro': (
            gettext_lazy('Çoklu doğrusal regresyon (OLS), bir bağımlı sürekli değişkeni birden '
        ...
        'when_to_use': (
            gettext_lazy('Sürekli bir bağımlı değişkeni birden fazla sürekli veya kategorik '
        ...
        'assumptions': (
            gettext_lazy('Doğrusallık: Bağımlı ve bağımsız değişkenler arasında doğrusal ilişki olmalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('R²: Modelin bağımlı değişkendeki varyansı açıklama oranı. '
        ...
        'apa_example': (
            gettext_lazy('Regresyon modeli toplam varyansın %43\'ünü açıklamıştır, '
            'R² = .43, F(3, 96) = 24.13, p < .001. Yalnızca çalışma süresi '
            'β = .52, t(96) = 5.87, p < .001 ile anlamlı bir yordayıcı olmuştur.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Kaç değişken ekleyebilirim?'),
                'a': (gettext_lazy('Kural olarak her değişken için en az 10–20 gözlem önerilir. '
                      'Çok sayıda değişken aşırı uyum (overfitting) riskini artırır.')),
            },
            {
                'q': gettext_lazy('VIF yüksek çıktı, ne yapmalıyım?'),
                'a': (gettext_lazy('VIF > 10 çoklu doğrusallık sorununa işaret eder. '
    ...
    'lojistik_regresyon': {
        'intro': (
            gettext_lazy('Lojistik regresyon, ikili (0/1) kategorik bir bağımlı değişkeni '
        ...
        'when_to_use': (
            gettext_lazy('Bağımlı değişkeniniz ikili kategorik olduğunda (hasta/sağlıklı, '
        ...
        'assumptions': (
            gettext_lazy('İkili bağımlı değişken: Sonuç değişkeni 0 ve 1 değerlerini almalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('Odds Oranı (OR): OR > 1 bağımsız değişken arttıkça olayın gerçekleşme '
        ...
        'apa_example': (
            gettext_lazy('Yaş değişkeni hastalık riskini anlamlı biçimde yordamıştır, '
            'OR = 1.08, %95 GA [1.03, 1.14], p = .002.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Lojistik regresyonda örneklem ne kadar büyük olmalı?'),
                'a': (gettext_lazy('Her bağımsız değişken için nadir sonuç (0 veya 1) kategorisinde '
            ...
            {
                'q': gettext_lazy('Sınıflandırma doğruluğu yeterli bir ölçüt mü?'),
                'a': (gettext_lazy('Dengesiz veri setlerinde doğruluk yanıltıcı olabilir. '
                      'AUC-ROC, duyarlılık (sensitivity) ve özgüllük (specificity) '
                      'birlikte değerlendirilmelidir.')),
            },
        ],
        'related_tools': [
            ('ki-kare', gettext_lazy('Ki-Kare Testi')),
            ('lineer-regresyon', gettext_lazy('Doğrusal Regresyon')),
            ('karar-agaci', gettext_lazy('Karar Ağacı')),
        ],
    },

    'friedman': {
        'intro': (
            gettext_lazy('Friedman Testi, tekrarlı ölçümler içeren üç veya daha fazla ilişkili '
        ...
        'when_to_use': (
            gettext_lazy('Aynı katılımcıların üç veya daha fazla farklı koşulda ölçüldüğü '
        ...
        'assumptions': (
            gettext_lazy('Tekrarlı ölçüm: Her birey tüm koşullarda ölçülmüş olmalıdır. '
            'Bağımsız bireyler: Katılımcılar birbirinden bağımsız olmalıdır. '
            'Sıralanabilirlik: Bağımlı değişken en az ordinal ölçekte olmalıdır.')
        ),
        'how_to_interpret': (
            gettext_lazy('χ² istatistiği ve p değeri: p < 0.05 en az iki ölçüm koşulu '
        ...
        'apa_example': (
            gettext_lazy('Üç ölçüm zamanı arasında puanlar anlamlı biçimde farklılaşmıştır, '
            'χ²(2) = 14.30, p = .001, W = .48.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Friedman mi, Tekrarlı Ölçümler ANOVA mı seçmeliyim?'),
                'a': (gettext_lazy('Normallik varsayımı sağlanıyorsa Tekrarlı Ölçümler ANOVA daha '
    ...
    'tekrarli_anova': {
        'intro': (
            gettext_lazy('Tekrarlı Ölçümler ANOVA, aynı bireylerin üç veya daha fazla koşul ya da '
        ...
        'when_to_use': (
            gettext_lazy('Aynı katılımcı grubunun üç veya daha fazla zamanda ya da koşulda '
        ...
        'assumptions': (
            gettext_lazy('Normallik: Her ölçüm noktasındaki veriler normal dağılımlı olmalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('F istatistiği ve p değeri: p < 0.05 ölçüm zamanları arasında anlamlı '
        ...
        'apa_example': (
            gettext_lazy('Ölçüm zamanı ana etkisi anlamlı bulunmuştur, F(1.74, 52.2) = 18.43, '
            'p < .001, ηp² = .38 (Greenhouse-Geisser düzeltmesi uygulanmıştır).')
        ),
        'faq': [
            {
                'q': gettext_lazy('Mauchly testi anlamlı çıktı, ne yapmalıyım?'),
                'a': (gettext_lazy('Küresellik ihlali var demektir. Analizus otomatik olarak '
                      'Greenhouse-Geisser düzeltmesini uygular; ayrıca bir işlem '
                      'yapmanıza gerek yoktur.')),
            },
            {
                'q': gettext_lazy('Bir katılımcının bir ölçümde verisi eksik, ne olur?'),
                'a': (gettext_lazy('Tekrarlı ANOVA tam veri gerektirir; eksik gözlem olan katılımcı '
    ...
    'karar_agaci': {
        'intro': (
            gettext_lazy('Karar ağacı, verileri hiyerarşik dal yapısı biçiminde bölerek '
        ...
        'when_to_use': (
            gettext_lazy('Kategorik bir sonuç değişkenini birden fazla özellik (feature) ile '
        ...
        'assumptions': (
            gettext_lazy('Bağımlı değişken: Kategorik (sınıflandırma) veya sürekli (regresyon). '
        ...
        'how_to_interpret': (
            gettext_lazy('Doğruluk (Accuracy): Doğru sınıflandırılan örneklerin oranı. '
        ...
        'apa_example': (
            gettext_lazy('Karar ağacı modeli (max_depth = 4) test setinde %82 doğruluk, '
            'AUC = .88 elde etmiştir. En önemli yordayıcı değişken X1 '
            'olarak belirlenmiştir (önem = .41).')
        ),
        'faq': [
            {
                'q': gettext_lazy('Karar ağacı mı, lojistik regresyon mu seçmeliyim?'),
                'a': (gettext_lazy('Yorumlanabilirlik ve doğrusal olmayan ilişkiler önemliyse '
                      'karar ağacı; istatistiksel katsayı ve olasılık yorumlaması '
                      'gerekiyorsa lojistik regresyon tercih edin.')),
            },
            {
                'q': gettext_lazy('Aşırı uyumu (overfitting) nasıl önlerim?'),
                'a': (gettext_lazy('max_depth, min_samples_leaf ve min_samples_split parametrelerini '
        ...
        'related_tools': [
            ('lojistik-regresyon', gettext_lazy('Lojistik Regresyon')),
            ('svm', gettext_lazy('Destek Vektör Makinesi')),
        ],
    },

    'svm': {
        'intro': (
            gettext_lazy('Destek Vektör Makinesi (SVM), sınıflar arasındaki marjini '
        ...
        'when_to_use': (
            gettext_lazy('İkili veya çok sınıflı sınıflandırma problemlerinde kullanın. '
        ...
        'assumptions': (
            gettext_lazy('Normalleştirme: Özellikler benzer ölçeğe getirilmelidir; '
        ...
        'how_to_interpret': (
            gettext_lazy('Doğruluk, F1 skoru, AUC-ROC: Sınıflandırma başarısının temel ölçütleri. '
        ...
        'apa_example': (
            gettext_lazy('RBF çekirdekli SVM modeli (C = 1.0, γ = "scale") test setinde '
            'F1 = .84, AUC = .91 değerlerine ulaşmıştır.')
        ),
        'faq': [
            {
                'q': gettext_lazy('SVM mi, karar ağacı mı tercih etmeliyim?'),
                'a': (gettext_lazy('SVM yüksek boyutlu verilerde ve az gözlemde güçlüdür; '
                      'ancak yorumlanması zordur. Karar ağacı daha yorumlanabilir '
                      've büyük veri setlerinde daha hızlıdır.')),
            },
            {
                'q': gettext_lazy('Çekirdek fonksiyonunu nasıl seçerim?'),
                'a': (gettext_lazy('Başlangıç olarak RBF çekirdeği deneyin; çoğu durumda iyi '
    ...
    'afa': {
        'intro': (
            gettext_lazy('Açıklayıcı Faktör Analizi (AFA), birbiriyle ilişkili gözlenen '
        ...
        'when_to_use': (
            gettext_lazy('Çok sayıda değişken arasındaki gizli yapıyı keşfetmek ve '
        ...
        'assumptions': (
            gettext_lazy('Örneklem büyüklüğü: Değişken başına en az 5–10 gözlem önerilir; '
        ...
        'how_to_interpret': (
            gettext_lazy('KMO (Kaiser-Meyer-Olkin): ≥ 0.80 "iyi", ≥ 0.70 "orta", '
        ...
        'apa_example': (
            gettext_lazy('KMO = .84, Bartlett χ²(66) = 512.3, p < .001. Varimax döndürme '
            'sonucunda toplam varyansın %58.4\'ünü açıklayan iki faktörlü '
            'yapı elde edilmiştir.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Kaç faktör seçmeliyim?'),
                'a': (gettext_lazy('Özdeğer > 1 (Kaiser), çizgi grafiği (scree plot) kırılma '
                      'noktası ve %50+ açıklanan varyans kriterlerini birlikte '
                      'değerlendirin. Yorum kolaylığı da önemli bir ölçüttür.')),
            },
            {
                'q': gettext_lazy('Döndürme yöntemi (rotation) nasıl seçilir?'),
                'a': (gettext_lazy('Faktörler birbirinden bağımsız olduğu varsayılıyorsa '
                      'Varimax (ortogonal); faktörler arasında korelasyon '
                      'bekleniyorsa Oblimin veya Promax (oblique) kullanın.')),
            },
            {
                'q': gettext_lazy('Bir madde birden fazla faktöre yüksek yük verdi, ne yapmalıyım?'),
                'a': (gettext_lazy('Çift yüklenen (cross-loading) maddeyi her iki faktördeki '
    ...
    'wilcoxon': {
        'intro': (
            gettext_lazy('Wilcoxon İşaret Testi, iki ilişkili ölçüm arasındaki farkı '
        ...
        'when_to_use': (
            gettext_lazy('Aynı gruba ait iki ölçümü karşılaştırmak istediğinizde '
        ...
        'assumptions': (
            gettext_lazy('Bağımlı çiftler: Her gözlem çifti aynı bireye veya eşleştirilmiş '
            'çifte ait olmalıdır. '
        ...
        'how_to_interpret': (
            gettext_lazy('W istatistiği: İki yönlü testte küçük W değeri anlamlılığa işaret eder. '
            'p değeri: p < 0.05 iki ölçüm arasında anlamlı fark var demektir. '
            'r (etki büyüklüğü): r = Z / √N; 0.1 küçük, 0.3 orta, 0.5 büyük.')
        ),
        'apa_example': (
            gettext_lazy('Sontest puanları öntest puanlarından anlamlı düzeyde yüksektir, '
            'Z = −3.42, p = .001, r = .48.')
        ),
        'faq': [
            {
                'q': gettext_lazy('Wilcoxon mu, bağımlı t-testi mi seçmeliyim?'),
                'a': (gettext_lazy('Fark puanları normal dağılım gösteriyorsa bağımlı t-testi '
